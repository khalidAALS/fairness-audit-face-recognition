...
CKPT = Path("models/fair_arcface_gender_resnet18.pth")

OUT_EMB = Path("outputs/fair_arcface_embeddings_train.npy")
OUT_LAB = Path("outputs/fair_arcface_labels_train.csv")
