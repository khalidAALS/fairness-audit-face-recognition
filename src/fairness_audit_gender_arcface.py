...
X_train = np.load("outputs/arcface_embeddings_train.npy")
y_train_df = pd.read_csv("outputs/arcface_labels_train.csv")

X_val = np.load("outputs/arcface_embeddings_val.npy")
y_val_df = pd.read_csv("outputs/arcface_labels_val.csv")
...
print("Overall gender accuracy (val) [ArcFace-backbone embeddings]:", overall_acc)
