...
X_train = np.load("outputs/fairface_embeddings_train.npy")
y_train_df = pd.read_csv("outputs/fairface_labels_train.csv")

X_val = np.load("outputs/fairface_embeddings_val.npy")
y_val_df = pd.read_csv("outputs/fairface_labels_val.csv")

# Only uses rows where a face was detected 
...
print("Overall gender accuracy (val):", overall_acc)
